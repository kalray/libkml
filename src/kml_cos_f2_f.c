...
float kml_cosf_f2_f_cos_table_lo[32][1]  = {
  {0.0f},
  {-0x1.80451ap-24f},
  {-0x1.866b96p-24f},
  {0x1.48750ep-24f},
...
double kml_cosf_f2_f_cos_table_ext[32]  = {0x1p0, 0x1.f6297cff75cbp-1, 0x1.d906bcf328d46p-1, 0x1.a9b66290ea1a3p-1, 0x1.6a09e667f3bcdp-1, 0x1.1c73b39ae68c8p-1, 0x1.87de2a6aea963p-2, 0x1.8f8b83c69a60bp-3, 0, -0x1.8f8b83c69a60bp-3, -0x1.87de2a6aea963p-2, -0x1.1c73b39ae68c8p-1, -0x1.6a09e667f3bcdp-1, -0x1.a9b66290ea1a3p-1, -0x1.d906bcf328d46p-1, -0x1.f6297cff75cbp-1, -0x1p0, -0x1.f6297cff75cbp-1, -0x1.d906bcf328d46p-1, -0x1.a9b66290ea1a3p-1, -0x1.6a09e667f3bcdp-1, -0x1.1c73b39ae68c8p-1, -0x1.87de2a6aea963p-2, -0x1.8f8b83c69a60bp-3, 0, 0x1.8f8b83c69a60bp-3, 0x1.87de2a6aea963p-2, 0x1.1c73b39ae68c8p-1, 0x1.6a09e667f3bcdp-1, 0x1.a9b66290ea1a3p-1, 0x1.d906bcf328d46p-1, 0x1.f6297cff75cbp-1};
...
float kml_cosf_f2_f_sin_table[32][1]  = {
  {0.0f},
  {0x1.8f8b84p-3f},
  {0x1.87de2ap-2f},
  {0x1.1c73b4p-1f},
...
double kml_cosf_f2_f_sin_table_ext[32]  = {0, 0x1.8f8b83c69a60bp-3, 0x1.87de2a6aea963p-2, 0x1.1c73b39ae68c8p-1, 0x1.6a09e667f3bcdp-1, 0x1.a9b66290ea1a3p-1, 0x1.d906bcf328d46p-1, 0x1.f6297cff75cbp-1, 0x1p0, 0x1.f6297cff75cbp-1, 0x1.d906bcf328d46p-1, 0x1.a9b66290ea1a3p-1, 0x1.6a09e667f3bcdp-1, 0x1.1c73b39ae68c8p-1, 0x1.87de2a6aea963p-2, 0x1.8f8b83c69a60bp-3, 0, -0x1.8f8b83c69a60bp-3, -0x1.87de2a6aea963p-2, -0x1.1c73b39ae68c8p-1, -0x1.6a09e667f3bcdp-1, -0x1.a9b66290ea1a3p-1, -0x1.d906bcf328d46p-1, -0x1.f6297cff75cbp-1, -0x1p0, -0x1.f6297cff75cbp-1, -0x1.d906bcf328d46p-1, -0x1.a9b66290ea1a3p-1, -0x1.6a09e667f3bcdp-1, -0x1.1c73b39ae68c8p-1, -0x1.87de2a6aea963p-2, -0x1.8f8b83c69a60bp-3};
float kml_cosf_f2_f_cos_table_hi[32][1]  = {
  {0x1p0f},
  {0x1.f6298p-1f},
  {0x1.d906cp-1f},
  {0x1.a9b66p-1f},
...
float kml_cos_f2_f(float x){
    ...
    if (__builtin_expect(lar_cond, 0)) {
        ...
        tmp = ml_exp_extraction_dirty_fp32(vx);
        tmp1 =  - tmp;
        ...
        tmp11 = float_to_32b_encoding(vx);
        ...
        tmp16 = tmp15;
        lar_tab_index = tmp16;
        lar_tab_cos_hi = kml_cosf_f2_f_cos_table_hi[lar_tab_index][INT32_C(0)];
        promote = lar_tab_cos_hi;
        lar_tab_cos_lo = kml_cosf_f2_f_cos_table_lo[lar_tab_index][INT32_C(0)];
        promote1 = lar_tab_cos_lo;
        tmp17 = promote + promote1;
        promote2 = lar_vx;
        tmp18 = promote2 * 0x1.921fb54442d18p-3;
        tmp19 =  - tmp18;
        lar_tab_sin = kml_cosf_f2_f_sin_table[lar_tab_index][INT32_C(0)];
        ...
        tmp = vx * 0x1.45f306p2f;
        k = __builtin_k1_fixed(_K1_FPU_NEAREST_EVEN, tmp, 0);
        modk = k % INT32_C(32);
        tab_cos_lo = kml_cosf_f2_f_cos_table_ext[modk];
        tab_sin_ext = kml_cosf_f2_f_sin_table_ext[modk];
        fk = k;
        red_vx_hi = __builtin_k1_ffms(vx, 0x1.921f8p-3f, fk);
        tmp1 =  - red_vx_hi;
        promote = tmp1;
        ...
        tmp3 = red_vx;
        tab_cos_hi = kml_cosf_f2_f_cos_table_hi[modk][INT32_C(0)];
        tmp4 = tab_cos_hi * red_vx;
        tab_sin = kml_cosf_f2_f_sin_table[modk][INT32_C(0)];
